    ...
    >
      ...
      <div className="h-full overflow-y-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          {/* SKILLS CONTAINER */}
          <div
            className="flex flex-col gap-12 justify-center lg:items-start items-center"
            ref={skillRef}
          >
            {/* SKILL TITLE */}
            <motion.h1
          ...
          <div
            className="flex flex-col gap-12 justify-center pb-48 lg:items-start items-center"
            ref={experienceRef}
          >
            {/* EXPERIENCE TITLE */}
            <motion.h1
